...
#
# data/fish/readme.txt describes the files generated by this script. 


# match taxonomy and get species codes -------
fish <- load_taxa()
dir.create("data/fish")
saveRDS(fish, "data/fish/fish_ds.RDS")
...
ala_fish |> 
  ...
  write_csv("data/fish/check_names_website.csv")

manual_match <- read_csv("data/fish/matched_on_website.csv") |> 
...
unmatched_anywhere <- read_csv("data/fish/unmatched_anywhere.csv") 
  
# get habitats ------
fb <- fb_tbl("species")
saveRDS(fb, "data/fish/species_ds.RDS")
